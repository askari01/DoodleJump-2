...
-(IBAction)alertMe {
	...
	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Doodle Space Jump!" message:@"Welcome to Doodle Space Jump. Simply just press the sides of the screen to move the Doodle around. Hit the platforms and get as High as you can. But be careful every bounce you do the platform will then quickly fall away " delegate:nil cancelButtonTitle:@"Cancel" otherButtonTitles:nil];
	[alert show];
	[alert release];
